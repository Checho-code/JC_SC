<!--ventana para Update--->
<div class="modal fade" id="editChildresn<?php echo $dataEmp['id_usuario']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="">
                <input type="hidden" name="id" value="<?php echo $dataEmp['id_usuario']; ?>">
                ...
                <div class="row justify-content-around mt-3 p-2">
                    ...
                    <div class="col-5">
                        ...
                        <input name="nombre" type="text" value="<?php echo $dataEmp['nombre_usuario']; ?>"
                    ...
                    <div class="col-5">
                        ...
                        <input name="apellido" type="text" value="<?php echo $dataEmp['apellido_usuario']; ?>"
                            class="form-control" <?php if (isset($_REQUEST['apellido']) && $_REQUEST['apellido'] != ''): ?> value="<?php echo $_REQUEST['apellido']; ?>" <?php endif; ?>>
                    </div>
                </div>
                ...
                <div class="row justify-content-around  mt-3 p-2">
                    ...
                    <div class="col-5">
                        ...
                        <input name="numero" type="text" value="<?php echo $dataEmp['num_doc']; ?>" class="form-control"
                ...
                <div class="row justify-content-around  mt-3 p-2">
                    <div class="col-5">
                        ...
                        <input name="tel" type="number" value="<?php echo $dataEmp['telefono']; ?>" class="form-control"
                    ...
                    <div class="col-5">
                        ...
                        <label for="tipo-rol" class="label">Rol Act. =><span style="color:orange">
                                <?php $r = $dataEmp['nivel'];
                                switch ($r) {
                                    case 1:
                                        echo '"Repartidor"';
                ...
                <div class="row justify-content-around mt-3 p-2">
                    ...
                    <div class="col-5">
                        ...
                        <input type="email" value="<?php echo $dataEmp['email']; ?>" name="correo" class="form-control "
                    ...
                    <div class="col-5">
                        ...
                        <div class="input-group ">
                            <input type="text" readonly value="<?php echo $dataEmp['rku']; ?>" class="form-control"
                                name="clave" id="password" <?php if (isset($_REQUEST['clave1']) && $_REQUEST['clave1'] != ''): ?> value="<?php echo $_REQUEST['clave']; ?>" <?php endif; ?>>
                        </div>
                    </div>
                ...
                <?php include 'ModificarE.php'; ?>
                <div class="modal-footer justify-content-center ">
                    <button type="button" class="btn btn-warning" data-dismiss="modal">Cerrar</button>
                    <button type="submit" name="btnUpEmp" class="btn"
                        style="color: #fff; background-color: #177c03; width: 220px; ">Guardar
                        Cambios</button>
                </div>
