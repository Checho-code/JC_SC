...
<div class="modal fade" id="verProdConLogueo<?php echo $consulta['id_producto']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            ...
            <form method="POST">
                <input type="hidden" name="id_producto" value="<?php echo $consulta['id_producto']; ?>">
                <input type="hidden" name="id_marca" value="<?php echo $consulta['id_marca']; ?>">
                ...
                <div class="row   mb-3 p-2 justify-content-around">
                    ...
                    <!-- <div class="contmasProd col-4 ">
                        <label for="cantidad" class="labelCant">Cantidad:</label>
                        <input type="number" max="99" name="cantidad" class="cantidad" value="0">

                    </div> -->

                    <!-- <div class="contAcarro col-4 ">
                        <button type="submit" name="btnAgregar" class="btnaddcar  rounded-5">Agregar <i
                                class="fa-solid fa-cart-plus" style="margin-left: 8px; font-size: 1.3em;"></i></button>
                    </div> -->
                </div>
        </div>
        </form>
