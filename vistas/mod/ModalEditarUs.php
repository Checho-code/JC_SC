      ...
      <form method="POST" action="">
        ...
        <div class="row justify-content-around mt-3 p-2">
          ...
          <div class="col-5">
            ...
            <input name="nombre" type="text" value="<?php echo $row_usuarios['nombre_usuario']; ?>" class="form-control"
        ...
        <div class="row justify-content-around  mt-3 p-2">
          ...
          <div class="col-5">
            ...
            <input name="numero" type="number" value="<?php echo $row_usuarios['num_doc']; ?>" class="form-control" <?php
               if (isset($_REQUEST['numero']) && $_REQUEST['numero'] != ''): ?> value="<?php echo $_REQUEST['numero']; ?>"
              <?php endif; ?>>
          </div>
        ...
        <div class="row justify-content-around mt-3 p-2">
          ...
          <div class="col-5">
            ...
            <input type="email" value="<?php echo $row_usuarios['email']; ?>" name="correo" class="form-control " <?php
               if (isset($_REQUEST['correo']) && $_REQUEST['correo'] != ''): ?> value="<?php echo $_REQUEST['correo']; ?>"
              <?php endif; ?>>
          </div>
        ...
        <?php include 'ModificarUs.php'; ?>


        <div class="modal-footer ">
          <button type="button" class="btn btn-warning" data-dismiss="modal">Cerrar</button>
          <button type="submit" name="btnUpUs" class="btn" style="color: #fff; background-color: #177c03; ">Guardar
            Cambios</button>
        </div>
