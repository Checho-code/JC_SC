<!--ventana para Update--->
<div class="modal fade" id="editDpto<?php echo $row_dpto['id_dpto']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST">
                <input type="text" name="id" value="<?php echo $row_dpto['id_dpto']; ?>">
                ...
                <div class="modal-body" id="cont_modal">
                    <div class="form-group mt-2">
                        ...
                        <input readonly name="nom_dpto" type="text" class="form-control "
                            value="<?php echo $row_dpto['nombre_dpto']; ?>">
                    </div>

                    <div class="form-group mt-3 mb-2">
                        <label for="tipo-docs">Estado Act. =>
                            <?php $est = $row_dpto['estado'];
