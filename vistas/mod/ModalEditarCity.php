<!--ventana para Update--->
<div class="modal fade" id="editCity<?php echo $dataCity['id_ciudad']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST">
                <input type="hidden" name="id" value="<?php echo $dataCity['id_dpto']; ?>">
                ...
                <div class="modal-body" id="cont_modal">
                    <div class="form-group mt-2">
                        ...
                        <input readonly name="nom_city" type="text" class="form-control " value="<?php echo $dataCity['nombre_ciudad']; ?>">
                    </div>
