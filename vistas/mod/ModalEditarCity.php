<!--ventana para Update--->
<div class="modal fade" id="editCity<?php echo $row_citys['id_ciudad']; ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST">
                <input type="hidden" name="id" value="<?php echo $row_citys['id_dpto']; ?>">
                ...
                <div class="modal-body" id="cont_modal">
                    <div class="form-group mt-2">
                        ...
                        <input readonly name="nom_city" type="text" class="form-control "
                            value="<?php echo $row_citys['nombre_ciudad']; ?>">
                    </div>
                ...
                <div class="modal-footer ">
                    ...
                    <button type="submit" class="btn" name="btnUpDpto"
