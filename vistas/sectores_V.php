...
<body>
  ...
  <div class="container mt-5 ">
    ...
    ?>
<h4 class="text-danger bg-black text-center">!!!!!! OJO llenar prrimero la BD, y luego seguir con esto ¡¡¡¡¡</h4>
    ...
    <div class="row text-center" style="background-color: #cecece">
      ...
      <div class="col-md-6">
        <strong>Lista de Sectores <span style="color: crimson"> ( <?php echo $cantidad; ?> )</span> </strong>
      </div>
    </div>
            ...
            <div class="col-sm-5">
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <label for="tipo-docs" class="mb-1">Seleccione un Departamento</label>
                  <select class="tip-doc form-control mb-3" name="departamento">
                  </select>
                ...
                <div class="form-group mt-2 mb-2 p-3" style=" background-color:#f6f6f6; border-radius: 20px; ">
                <h5 class="text-center mb-3" style="color:#177c03">Ciudad</h5>
                <label for="tipo-docs" class="mb-1">Seleccione una Ciudad</label>
                  <select class="tip-doc form-control mb-3" name="departamento">
                  </select>
                  <label for="tipo-docs" class="mb-1">Seleccione su estado </label>
                  <select class="tip-doc form-control" name="estadoDepto">
                ...
                <div class="form-group mt-2 mb-5 p-3" style=" background-color:#f6f6f6; border-radius: 20px; ">
                <h5 class="text-center mb-3" style="color:#177c03">Sector</h5>
                <label for="tipo-docs" class="mb-1">Seleccione un Sector</label>
                  <select class="tip-doc form-control mb-3" name="departamento">
                  </select>
                  <label for="tipo-docs" class="mb-1">Seleccione su estado </label>
                  <select class="tip-doc form-control" name="estadoDepto">
