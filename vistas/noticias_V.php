                                        ...
                                        <table class="table table-bordered table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="background-color: #cecece; font-size: 0.85rem;">Publicado
                                                    </th>
                                                    <th style="background-color: #cecece; font-size: 0.85rem;">Titulo
                                                    </th>
                                                    <th style="background-color: #cecece; font-size: 0.85rem;">Noticia
                                                    </th>
                                                    <th style="background-color: #cecece; font-size: 0.85rem;">Estado
                                                    </th>
                                                    <th style="background-color: #cecece; font-size: 0.85rem;">imagen
                                                    </th>
