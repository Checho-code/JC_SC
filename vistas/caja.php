...
<body>
    <div class="container-fluid mt-5 mb-5 ">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <h2 style="color: #177c03; text-align: center;">Saldo en caja:
                    <?php echo number_format($row_caja['ingresos'] - $row_caja['egresos']);
                    $saldo = $row_caja['ingresos'] - $row_caja['egresos']; ?>
                </h2>
                <h3 style="color: #177c03; text-align: center;">Cierre de caja: </h3>
                <form name="cierre" method="post">
                    ...
                    <div class="form-group mt-5 mb-5">
                        ...
                        <input type="hidden" class="form-control" required placeholder="ingrese el saldo a cerrar"
                            value="<?php echo $saldo; ?>" name="saldo">
                    </div>

                    <div class="form-group mt-5 mb-5">
                        <label for="saldo">Clave maestra: *</label>
                        <input type="password" class="form-control" required placeholder="ingrese la clave para cierre"
                            name="clave_maestra" autocomplete="off">
                    </div>
