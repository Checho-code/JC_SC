...
<body>
	<!--Form registro-->
		...
		<div class="container-fluid bg-warning mt-5 w-75">
			...
			<form class="row form_regis needs-validation" novalidate method="post" id="registro">
				...
				<div class="row justify-content-around mt-3 p-2">
					...
					<div class="entradas col-5">
						<label for="correo1s" class="label">Correo *</label>
						<input required type="email" name="correo1" class="form-control in" <?php if (isset($_REQUEST['correo1']) && $_REQUEST['correo1'] != '') : ?> value="<?php echo $_REQUEST['correo1']; ?>" <?php endif; ?>>
					</div>

					<div class="entradas col-5">
						<label for="correo2s" class="label">Repetir correo *</label>
						<input required type="email" name="correo2" class="form-control in" <?php if (isset($_REQUEST['correo2']) && $_REQUEST['correo2'] != '') : ?> value="<?php echo $_REQUEST['correo2']; ?>" <?php endif; ?>>
					</div>
				...
				<div class="row justify-content-around mt-3 p-2">
					...
					<div class="col-5">
						...
						<div class="input-group ">
							<input required type="password" class="form-control in" name="clave1" id="password" <?php if (isset($_REQUEST['clave1']) && $_REQUEST['clave1'] != '') : ?> value="<?php echo $_REQUEST['clave1']; ?>" <?php endif; ?>>
					...
					<div class="col-5">
						...
						<div class="input-group ">
							<input required type="password" class="form-control in" name="clave2" id="password1" <?php if (isset($_REQUEST['clave2']) && $_REQUEST['clave2'] != '') : ?> value="<?php echo $_REQUEST['clave2']; ?>" <?php endif; ?>>

						</div>
					</div>

				</div>
				<div class="row justify-content-around mt-5  p-2">
					<div class="term-cond col-3">
						<label class="form-label acepto" for="contrato">Acepto el <a href="contrato.html" target="_blanck" class="link1">Contrato</a>*</label>
...
<form class="row form_regis needs-validation" novalidate method="post" id="registro">
	...
	<div class="row bg-info">
		<div class="entradas col-6">
			...
			<input name="nombre" type="text" autofocus="autofocus" class="form-control in" <?php if (isset($_REQUEST['nombre']) && $_REQUEST['nombre'] != '') : ?> value="<?php echo $_REQUEST['nombre']; ?>" <?php endif; ?>>
		</div>

		<div class="entradas col-6">
			<label for="apellidos" class="label">Apellido *</label>
			<input required name="apellido" type="text" class="form-control in" <?php if (isset($_REQUEST['apellido']) && $_REQUEST['apellido'] != '') : ?> value="<?php echo $_REQUEST['apellido']; ?>" <?php endif; ?>>
		</div>
	</div>
	...
	<div class="entradas col-4">
		<label for="num-docs" class="label">Número docuemnto *</label>
		<input required name="numero" type="number" class="form-control in" <?php if (isset($_REQUEST['numero']) && $_REQUEST['numero'] != '') : ?> value="<?php echo $_REQUEST['numero']; ?>" <?php endif; ?>>
	</div>

	<div class="entradas col-4">
		<label for="num-tel" class="label">Número telefono *</label>
		<input required name="tel" type="number" class="form-control in" <?php if (isset($_REQUEST['tel']) && $_REQUEST['tel'] != '') : ?> value="<?php echo $_REQUEST['tel']; ?>" <?php endif; ?>>
	</div>
