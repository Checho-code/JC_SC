                            ...
                            <form method="post" enctype="multipart/form-data"
                                ...
                                <div class="row justify-content-around  mt-3 p-2">
                                    <div class="col-5">
                                        ...
                                        <input name="nombre" type="text" class="form-control"
                                            placeholder="Ingrese nombre del producto" autocomplete="off"
                                    ...
                                    <div class="col-5">
                                        ...
                                        <input type="text" maxlength="6" name="precio"
                                            placeholder="Ingrese precio de venta" class="form-control"
                                            autocomplete="off"
                                            onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" min="1"
                                            <?php if (isset($_REQUEST['precio']) && $_REQUEST['precio'] != '') : ?>
                                            value="<?php echo $_REQUEST['precio']; ?>" <?php endif; ?> />
                                    </div>
                                ...
                                <div class="row justify-content-around  mt-3 p-2">
                                    <div class="col-5">
                                        ...
                                        <input name="unidad" type="text" class="form-control"
                                            placeholder="Ejm: Kilo, Libra, Unidad....." autocomplete="off"
                                            <?php if (isset($_REQUEST['unidad']) && $_REQUEST['unidad'] != '') : ?>
                                            value="<?php echo $_REQUEST['unidad']; ?>" <?php endif; ?>>
                                    </div>
                                ...
                                <div class="row justify-content-around  mt-3 p-2">
                                    <div class="col-5">
                                        ...
                                        <textarea name="descripcion" type="text" class="form-control"
                                            placeholder="Ingrese una descripcion corta" autocomplete="off"
                                            <?php if (isset($_REQUEST['descripcion']) && $_REQUEST['descripcion'] != '') : ?>
                                            value="<?php echo $_REQUEST['descripcion']; ?>" <?php endif; ?>></textarea>
                                    </div>
                                ...
                                <div class="row justify-content-around mt-3 p-2">
                                    ...
                                    <div class="botonera col-5">
                                        ...
                                        <input type="submit" name="btnSaveProd" value="Guardar" class="btn"
