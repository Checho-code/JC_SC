...
$b_carrito = mysqli_query($conexion, "SELECT id_registro, idProducto, fecha, invitado, cantidad, precio_costo, estado FROM carrito WHERE idCliente IS  NULL ");
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Llene los campos para recibir su pedido
								</h5>
