	...
	<div class="contenedor">
		...
		<div class="container-fluid  secundario ">
			...
			<div class="row cont-marcas">
				...
				<?php
				$query = mysqli_query($conexion, "SELECT * FROM marcas  WHERE nom_marca != 'Frutos del campo'");
				...
				while ($consulta = mysqli_fetch_array($query)) { ?>
					<div class="col-4 columnasP ">
						<div class="card  tarjetaP ">
							...
							<div class=" mt-3">
								<button type="button" class="ver" data-toggle="modal" data-target="#verProdSinLogueo<?php echo $consulta['id_producto'] ?>">Ver</button>
